...
export function Header({ activeTab, onTabChange, showWorkflows = true, showDemos = true }: HeaderProps) {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", gap: sz(6), fontFamily: theme.font.mono, fontSize: sz(12) }}>
        {showWorkflows && (
          <button
            onClick={() => onTabChange("home" as TabKey)}
            style={{
              ...
              fontFamily: theme.font.mono, fontSize: sz(12), fontWeight: activeTab === "home" ? 600 : 400,
              transition: "all 0.2s",
            }}
          >
            ⌂ Workflows
        ...
        {showDemos && (
          <button
            ...
            style={{
              ...
              fontFamily: theme.font.mono, fontSize: sz(12), fontWeight: activeTab === "demos" ? 600 : 400,
              transition: "all 0.2s",
            }}
          >
            ▷ Demos
