...
export interface AgentResponse {
  ...
  message_type?: "thought" | "action" | "observation" | "answer" | "final-answer" | "explain" | "chunk" | "error";
  /** @deprecated Use message_type — kept for backward compat with older backends */
