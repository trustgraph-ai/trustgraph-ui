...
export type { Schema, SchemaField, SchemaTableRow } from "./model/schema-types";
export { useOntologies } from "./state/ontologies";
export type { Ontology, OntologyMetadata, OWLClass, OWLObjectProperty, OWLDatatypeProperty, OWLBaseProperty } from "./state/ontologies";
